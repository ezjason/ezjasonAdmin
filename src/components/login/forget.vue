    ...
    <div class="forget-index">
      ...
      { required: true, message: '用户名不能为空'}
            ...
            <el-form-item
              ...
              prop="password"
              :rules="[
      { required: true, message: '新登录密码不能为空'}
    ]"
            >
      ...
      { required: true, message: '验证码不能为空'}
            ...
            <el-form-item class="el-item">
              <el-button element-loading-background="rgba(122, 123, 125, 0.5)" type="primary" class="login-btn"
                         @click="submitForm('loginForm')" v-loading.fullscreen.lock="fullscreenLoading">确定
              </el-button>
              <span class="text">点击"注册"即表示您同意并愿意遵守 <a href="https://www.gsc.cn/protocol.html" > 服务协议</a></span>
            </el-form-item>
          </el-form>
